...
RUNTIMELIBRARYFLAGS="-L./ -Wl,-rpath -Wl,./" # -l libusb-1.0
cosmocc $FLAGS $RUNTIMELIBRARYFLAGS  example.c -o bin/rtl-sdr-test $objects

./zip -j ./bin/rtl-sdr-test ./deps/libusb-1.0.*
